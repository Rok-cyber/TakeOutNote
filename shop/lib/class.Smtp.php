...
*
* 참 고: 희망주기 clss.SmtpX.php (http://cafe.naver.com/hopegiver.cafe)
*
* 제작일: 2003.08.12 
*
* =======================================================
...
*/
    ...
    function build_data($subject, $body) {
        ...
        if($this->ctype=="text/html") $body = stripslashes($body);
        
		$mime .= "Subject: $subject\r\n";
        $mime .= "Date: ".date ("D, j M Y H:i:s T",time())."\r\n";
        $mime .= "MIME-Version: 1.0\r\n";
        //$mime .= "Content-Type: ."$ctype."; boundary=\"".$boundary."\"\r\n\r\n"."This is a multi-part message in MIME format.\r\n\r\n";
        $mime .= "X-Priority: 1\r\n"; 
...
} // End of if(!isset($__PREVIL_SMTP__ ) 
?>