...
$file_name = "itsMallOrderCancelList_".date("Ymd",time());
...
$tpl->define("main","orderg_excel.html");
$tpl->scan_area("main");

/*********************************** QUERY **********************************/
if(eregi("b.",$where)) {
	$query = "SELECT a.uid, a.p_cate, a.p_number, a.order_num, a.p_name, a.p_qty, a.p_price, a.op_price, a.sale_price, a.order_status as status, a.order_status2 as status2, a.carr_info, a.carriage FROM mall_order_goods as a, mall_order_info as b WHERE a.order_num=b.order_num {$where} ORDER BY a.uid DESC";
}
else {
	$query = "SELECT a.uid, a.p_cate, a.p_number, a.order_num, a.p_name, a.p_qty, a.p_price, a.op_price, a.sale_price, a.order_status as status, a.order_status2 as status2, a.carr_info, a.carriage FROM mall_order_goods as a WHERE a.uid>0 {$where} ORDER BY a.uid DESC";
}	
