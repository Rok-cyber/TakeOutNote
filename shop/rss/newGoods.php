...
/**************************** GOODS LIST**************************/
$sql = "SELECT uid,cate,number,name,price,price_ment,image3,image4,icon,comp,reserve,c_cnt,event FROM mall_goods WHERE s_qty !='3' && type='A' {$where} ORDER BY uid DESC LIMIT 50";
$mysql->query($sql);
